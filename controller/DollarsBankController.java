...
import com.dollarsbank.utility.DataGeneratorStub;
...
public class DollarsBankController {
	...
	// this is the controller
		...
		public static ConsolePrinter cpu = new ConsolePrinter();
		
		public static DataGeneratorStub dgsu = new DataGeneratorStub();
		...
		static {
			...
			jeeves.add(new Customer(4,"Bob", "Builder", "928-888-4203", "lakiki", "pokiki", "124 hanger way"));
		...
		public void custCommInterface(int user, int iterator) {
			...
			if (commChosen == 1) {
				...
				try {
					...
					dgsu.stubGenerator(jeeves.get(iterator));
